    ...
    >
      ...
      <a-form-item label="题目列表" :content-flex="false" :merge-props="false">
        ...
        <div v-for="(question, index) in questionContent" :key="index">
          ...
          <a-form-item filed="posts.post1" :label="`题目标题`">
            <a-input v-model="question.title" placeholder="请输入标题" />
          </a-form-item>
          <!--          题目选项-->
          <a-space size="large">
            <h4>题目 NO.{{ index + 1 }}选项列表</h4>
            <a-button
              size="small"
          ...
          >
            <a-form-item label="选项序号">
              <a-input v-model="option.key" placeholder="请输入选项序号" />
            </a-form-item>
