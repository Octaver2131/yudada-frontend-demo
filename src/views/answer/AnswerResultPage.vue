    ...
    <a-card>
      <a-row style="margin-bottom: 16px">
        <a-col flex="auto" class="content-wrapper">
          ...
          <p>描述结果：{{ data.resultDesc }}</p>
          <p>结果 ID：{{ data.resultId }}</p>
          <p>结果分数：{{ data.resultScore }}</p>
...
// 分享链接
const shareLink = `${window.location.protocol}//${window.location.host}/userAnswer/detail/${props.id}`;
